...
model_path = "weights_models/fasterrcnn_resnet50_part_2.pth"
csv_results_path = "fasterrcnn_resnet50_predection_results.csv"
    ...
    def model(self): 
        if not self._model:
            ...
            if os.path.exists(self.model_path):
                ...
                train_set_path = 'saraay@post.jce.ac.il/train_part_b'
                self.train_model(self._model, train_set_path)
        
        return self._model

    def train_model(self, model_to_train: FasterRCNN, train_set_path: str):
        train_dataset: datasets.ImageFolder = AncientScrollDataset(train_set_path)
...
#     validation_imgs_dir = 'saraay@post.jce.ac.il/train_part_b'
